      ...
      try {
        ...
        if (typeof __firebase_config !== "undefined" && __firebase_config) {
          try {
            ...
            console.error(
              "FirebaseProvider: Error parsing __firebase_config:",
              e
            );
            setFirebaseError(
          ...
          console.log(
            "FirebaseProvider: Global __firebase_config not found. Using process.env.NEXT_PUBLIC_ for Firebase Config."
          );
          firebaseConfig = {
          ...
          if (user) {
            ...
            if (
              ...
              try {
                ...
                console.error(
                  "FirebaseProvider: Error signing in with custom token:",
                  tokenError
                );
                ...
                try {
                  ...
                  console.error(
                    "FirebaseProvider: Error signing in anonymously:",
                    anonError
                  );
                  setFirebaseError(
                    `Authentication failed: ${anonError.message}`
                  );
        ...
        console.error(
          "FirebaseProvider: Failed to initialize Firebase or authentication:",
          err
        );
        setFirebaseError(
