...
import { LogOut, UserCircle } from "lucide-react"; // Icons for UI
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-gray-500 text-center">
            ...
            <span className="font-mono text-gray-700 break-all">
              company-id-placeholder-abcde12345
            </span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          >
            ...
            <p className="mt-2 text-green-700">
              Create and publish new job listings to attract top talent.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-purple-700">
              Edit, close, or view details of your active and past job postings.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-yellow-700">
              Review applications, manage candidates, and track their progress.
            </p>
